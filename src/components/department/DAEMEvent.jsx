...
function DAEMEvent({data, onSelectChange}) {
    return (
        <div>
            ...
            <div className="row bg-primary-subtle" style={{height: "40vh"}}>
                        ...
                        <div className="row">
                            ...
                            <div className="col-3 bg-danger-subtle" style={{borderRadius:"10px 0 0 10px"}}>
                                <input className="form-check-input" type="radio" name="notification"
                                       id="radioResponseInfo"/>
                                <label className="form-check-label" htmlFor="radioResponseInfo">
                                    Bilgi Talebi
                                </label>
                            </div>
                ...
                <div className="col-3 ps-4 user-select-none" style={{fontSize: "10px"}}>
                    <div className="row">
                        <div className="row ps-4">Olay Tanımı</div>
                        <div className="row">
                            <div className="mb-1">
                    ...
                    <div className="row">
                        <div className="row ps-4">Afad Açıklama</div>
                        <div className="row">
                            <div className="mb-1">
                                <textarea className="form-control" id="exampleFormControlTextarea1" rows={3}
                                          readOnly={true}
                    ...
                    <div className="row">
                        <div className="row ps-4">Tüm Kurum Açıklamaları</div>
                        <div className="row">
                            <div className="mb-1">
            ...
            <div className="row overflow-hidden p-0 m-0" style={{height: "38vh"}}>
                <DepartmentOperations name={"daem"}/>
            </div>
        </div>
    );
}

export default DAEMEvent;