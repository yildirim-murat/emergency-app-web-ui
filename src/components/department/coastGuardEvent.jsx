...
function CoastGuardEvent({data, onSelectChange}) {
    return (
        <div>
            ...
            <div className="row bg-primary-subtle" style={{height: "40vh"}}>
                ...
                <div className="col-3 ps-4 user-select-none" style={{fontSize: "10px"}}>
                    ...
                    <div className="row">
                        <div className="row">Sahil Güvenlik Açıklama Yazınız</div>
                        <div className="row">
                            <div className="mb-1">
                                <textarea className="form-control" id="exampleFormControlTextarea1" rows={2}
                    ...
                    <div className="row">
                        <div className="row">Sahil Güvenlik Açıklamaları</div>
                        <div className="row">
                            <div className="mb-1">
                                <textarea className="form-control" id="exampleFormControlTextarea1" rows={2}
                                          readOnly={true}
            ...
            <div className="row overflow-hidden p-0 m-0" style={{height: "38vh"}}>
                <DepartmentOperations name={"coastGuard"}/>
            </div>
        </div>
    );
}

export default CoastGuardEvent;