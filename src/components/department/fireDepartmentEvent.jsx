...
function FireDepartmentEvent({data, onSelectChange}) {
    return (
        <div>
            ...
            <div className="row bg-primary-subtle" style={{height: "40vh"}}>
                ...
                <div className="col-3 ps-4 user-select-none" style={{fontSize: "10px"}}>
                    ...
                    <div className="row">
                        <div className="row">İtfaiye Kurum Açıklaması</div>
                        <div className="row">
                            <div className="mb-1">
            ...
            <div className="row overflow-hidden p-0 m-0" style={{height: "38vh"}}>
                <DepartmentOperations name={"fireDepartment"}/>
            </div>
        </div>
    );
}

export default FireDepartmentEvent;